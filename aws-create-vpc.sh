...
SUBNET_PUBLIC_AZ="ap-south-1"
SUBNET_PUBLIC_NAME="10.0.1.0 - ap-south-1"
SUBNET_PRIVATE_CIDR="10.0.2.0/24"
SUBNET_PRIVATE_AZ="ap-south-1"
SUBNET_PRIVATE_NAME="10.0.2.0 - ap-south-1"
CHECK_FREQUENCY=5
#
#==============================================================================
...
#3NAT_GW_ID=$(aws ec2 create-nat-gateway \
#  --subnet-id $SUBNET_PUBLIC_ID \
